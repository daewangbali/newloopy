...
<form id="modifyNoticeForm" method="post" action="/notice/modify">
		...
		<table class="table" style="width: 100%">
			<tr>
				...
				<br>
					<span>제목 : </span> &nbsp 
					<input type="text" name="title" required="required" size="100" style="margin-top: 3px" value="${noticeVO.title}">
				<br>
				<br>
				<span style="margin-bottom: 20px">내용 : </span> &nbsp
				<textarea rows="10" class="form-control" name="content"  required="required">${noticeVO.content}</textarea>
