		...
		<div class="row">
			...
			<div class="col-lg-2" style="margin: " >
				...
				<div class="list-group" >
					<a href="#" class="list-group-item" style="color: hotpink;">Category 1</a>
					<a href="#" class="list-group-item" style="color: hotpink;">Category 2</a> 
					<a href="#" class="list-group-item" style="color: hotpink;">Category 3</a>
				</div>
